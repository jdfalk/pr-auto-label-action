...
- This is a composite GitHub Action that embeds Python logic directly in
  action.yml.
- All changes to PR auto-labeling logic should be made in the embedded Python
...
This repository provides a composite GitHub Action that automatically applies
intelligent labels to pull requests based on content analysis.
